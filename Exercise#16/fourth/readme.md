...
3. Ко второму заданию добавляется заголовок канального уровня. Клиент ждет 

ответа от сервера (фильтруя ненужные пакеты) и при получении ответа выводит строку из ответа сервера.
```